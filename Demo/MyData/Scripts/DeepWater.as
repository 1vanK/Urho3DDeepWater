...
void CreateScene()
{
    ...
    lightNode.LookAt(Vector3(1.0f, -1.0, -1.0f));
    ...
    waterNode.position = Vector3(0.0f, 20.0f, 0.0f);

    StaticModel@ water = waterNode.CreateComponent("StaticModel");
    water.model = cache.GetResource("Model", "Models/Plane.mdl");
    water.material = cache.GetResource("Material", "Materials/DeepWater.xml");
    ...
    cameraNode.position = Vector3(0.0f, 27.0f, -20.0f);
}
...
void SetupViewports()
{
    renderer.SetDefaultRenderPath(cache.GetResource("XmlFile", "RenderPaths/DeepWaterForwardHWDepth.xml"));
